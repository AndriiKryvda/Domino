...
- Name: ui.spec.ts >> 19. Lifecycle Edge Cases >> TC-19.1 — Leave During Lobby
- Location: tests\ui.spec.ts:845:7
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - heading "Game Lobby" [level=2] [ref=e6]
    - generic [ref=e7]:
      - generic "Click to copy code" [ref=e8] [cursor=pointer]: W48UDZ
      - button "EN" [ref=e9] [cursor=pointer]
  - paragraph [ref=e10]: "Share the code or click it to copy the invite link. Target: 100 pts · Timer: 60s"
  - list [ref=e11]:
    - listitem [ref=e12]:
      - generic [ref=e13]:
        - text: Host
        - generic [ref=e14]: Host
        - generic [ref=e15]: (you)
  - generic [ref=e16]:
    - button "+ Easy Bot" [ref=e17] [cursor=pointer]
    - button "+ Medium Bot" [ref=e18] [cursor=pointer]
    - button "+ Hard Bot" [ref=e19] [cursor=pointer]
  - generic [ref=e20]:
    - button "Need 2+ players" [disabled] [ref=e21] [cursor=pointer]
    - button "Leave" [ref=e22] [cursor=pointer]
```
